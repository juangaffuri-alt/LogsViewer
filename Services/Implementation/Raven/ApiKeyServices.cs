...
using LogsViewer.Services.Implementation.Raven.Indexes;
using LogsViewer.Services.Implementation.Raven.Models;
using LogsViewer.Services.Implementation.Utils;
...
public class ApiKeyServices : IApiKeyServices
{
    ...
    public async ValueTask<bool> VerifyApiKey(string? key, CancellationToken cancellationToken)
    {
        ...
        {
            System.Diagnostics.Debug.Assert(cacheKeysObject is not null);
